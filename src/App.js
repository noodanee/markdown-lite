...
class App extends Component {
  ...
  render() {
    ...
    const mdEditingClass = classnames({
      "lite-md-editing": !isImmersiveEditing,
      "lite-md-editing-immersive": isImmersiveEditing,
      "lite-md-editing-hide": !isEditAreaOpen,
    });

    const styleEditingClass = classnames({
      "lite-style-editing": true,
      "lite-style-editing-hide": isImmersiveEditing,
    });

    const richTextClass = classnames({
      "lite-marked-text": true,
      "lite-marked-text-pc": previewType === "pc",
      "lite-marked-text-hide": isImmersiveEditing || !isPreviewAreaOpen,
    });

    const richTextBoxClass = classnames({
      "lite-wx-box": true,
      "lite-wx-box-pc": previewType === "pc",
    });

    const textContainerClass = classnames({
      "lite-text-container": !isImmersiveEditing,
      "lite-text-container-immersive": isImmersiveEditing,
    });
        ...
        {({defaultTitle, onStyleChange, onStyleBlur, onStyleFocus, token}) => (
          <div className="lite-app">
            ...
            <div className={textContainerClass}>
              <div id="lite-md-editor" className={mdEditingClass} onMouseOver={(e) => this.setCurrentIndex(1, e)}>
              ...
              <div id="lite-rich-text" className={richTextClass} onMouseOver={(e) => this.setCurrentIndex(2, e)}>
                <Sidebar />
                <div
                  id={BOX_ID}
              ...
              {isStyleEditorOpen && (
                <div id="lite-style-editor" className={styleEditingClass}>
