...
class Font extends Component {
  ...
  render() {
    return (
      <div id="lite-menu-font" className="lite-menu-item" onClick={this.toggleFont}>
        <span>
          <span className="lite-menu-flag">{!this.state.isSerif && <span>{RIGHT_SYMBOL}</span>}</span>
          <span className="lite-menu-name">衬线字体</span>
        </span>
      </div>
    );
  }
