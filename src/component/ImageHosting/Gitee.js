    ...
    return (
      <Form {...formItemLayout}>
        <Form.Item label="用户名" style={style.formItem}>
          <Input value={username} onChange={this.usernameChange} placeholder="用户名" />
        </Form.Item>
        <Form.Item label="仓库名" style={style.formItem}>
          <Input value={repo} onChange={this.repoChange} placeholder="仓库名" />
        </Form.Item>
        <Form.Item label="token" style={style.formItem}>
          <Input value={token} onChange={this.tokenChange} placeholder="token" />
        </Form.Item>
