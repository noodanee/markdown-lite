...
class Footer extends Component {
  ...
  render() {
    ...
    return (
      <div className="lite-footer-container">
        <p>
          行数：
          {lineCount}
        </p>
        ...
        {isPasteHtmlChecked && (
          <div className="lite-footer-message" onClick={this.handleMessage}>
            点击使用
            <Dropdown overlay={menu} trigger={["click"]} overlayClassName="lite-footer-overlay" placement="topLeft">
              <a
                id="lite-footer-engine"
                className="lite-footer-engine"
                href="#"
                onClick={(e) => {
                  e.stopPropagation();
                }}
